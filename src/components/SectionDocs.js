                ...
                <div className="block-content">
                  <div className={classNames('grid', {'grid-col-2': _.get(section, 'col_number', null) === 'two', 'grid-col-3': _.get(section, 'col_number', null) === 'three'})}>
                    {_.map(_.get(this.props, 'pageContext.site.data.doc_sections.sections', null), (doc_section, doc_section_idx) => {
                        let doc_section_folder = _.get(this.props, 'pageContext.site.data.doc_sections.root_folder', null) + doc_section;
                        ...
                        return (
                          <div key={doc_section_idx} className="grid-item">
                            <div className="grid-item-inside">
                              <h3 className="grid-item-title line-left"><Link to={safePrefix(_.get(doc_section_page, 'url', null))}>{_.get(doc_section_page, 'frontmatter.title', null)}</Link></h3>
                              ...
                              <div className="grid-item-buttons">
                                <Link to={safePrefix(_.get(doc_section_page, 'url', null))}>Learn More</Link>
                              </div>
                            </div>
                          </div>
                        )
